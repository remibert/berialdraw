...
namespace berialdraw
{
	...
	public:
		...
		/** Add image in svg from original image file (PNG, JPEG)
		@param filename Path to the image file
		@param x X position in the SVG (in logical pixels)
		@param y Y position in the SVG (in logical pixels)
		...
		virtual void add_image_file(const char * filename, int32_t x, int32_t y, uint32_t display_width, uint32_t display_height, uint8_t alpha, Coord angle = 0);
