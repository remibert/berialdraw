...
void Switch::test1()
{
	...
	"["
		...
		"{'type':'touch','x':166,'y': 36,'state':'down'},"
		"{'type':'touch','x':166,'y': 36,'state':'up'},"
		"{'type':'touch','x':165,'y': 98,'state':'down'},"
		"{'type':'touch','x':165,'y': 98,'state':'up'},"
		"{'type':'touch','x':158,'y':153,'state':'down'},"
		"{'type':'touch','x':158,'y':153,'state':'up'},"
		"{'type':'touch','x':167,'y':216,'state':'down'},"
		"{'type':'touch','x':167,'y':216,'state':'up'},"
		"{'type':'touch','x': 86,'y':261,'state':'down'},"
		"{'type':'touch','x': 86,'y':261,'state':'up'},"
		"{'type':'touch','x': 88,'y':297,'state':'down'},"
		"{'type':'touch','x': 88,'y':297,'state':'up'},"
		"{'type':'touch','x':100,'y':338,'state':'down'},"
		"{'type':'touch','x':100,'y':338,'state':'up'},"
		"{'type':'touch','x':141,'y':392,'state':'down'},"
		"{'type':'touch','x':141,'y':392,'state':'up'},"
