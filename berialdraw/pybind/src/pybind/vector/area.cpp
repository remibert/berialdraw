...
void bind_area(py::module& m) {
    py::class_<berialdraw::Area>(m, "Area")
        .def(py::init<const berialdraw::Point&, const berialdraw::Size&>(),
        ...
        .def_property("size",
            ...
            [](berialdraw::Area& self, py::object value) {
                if (py::isinstance<py::tuple>(value) || py::isinstance<py::list>(value)) {
                    ...
                    throw std::invalid_argument("size must be tuple/list of 2 values");
                }
