...
void bind_scroll_view(pybind11::module_& m) {
    ...
    // Size and position properties using helpers
    bind_size_property<berialdraw::ScrollView>(cls, "scroll_size",
    ...
    bind_point_property<berialdraw::ScrollView>(cls, "scroll_position",
