...
void Sketch::test1()
{
	...
	UIManager::desktop()->dispatch("${tests}/out/sketch1_1.svg");
	rect->size(360,10);
	computer->size(rect->size());
	maison->size(rect->size());
	UIManager::desktop()->dispatch("${tests}/out/sketch1_2.svg");
	rect->size(360,360);
	computer->size(rect->size());
	maison->size(rect->size());
	UIManager::desktop()->dispatch("${tests}/out/sketch1_3.svg");
	rect->size(60,360);
	computer->size(rect->size());
	maison->size(rect->size());
	UIManager::desktop()->dispatch("${tests}/out/sketch1_4.svg");
	rect->size(360,60);
	computer->size(rect->size());
	maison->size(rect->size());
	UIManager::desktop()->dispatch("${tests}/out/sketch1_5.svg");
}
...
void Sketch::test2()
{
	...
	UIManager::desktop()->dispatch("${tests}/out/sketch2_1.svg");
	...
	UIManager::desktop()->dispatch("${tests}/out/sketch2_2.svg");
	...
	UIManager::desktop()->dispatch("${tests}/out/sketch2_3.svg");
}
...
void Sketch::test3()
{
	...
	Sketch * maison = new Sketch(canvas);
		...
		maison->size(rect->size());
		maison->filename("${icons}/maison.icn");
	UIManager::desktop()->dispatch("${tests}/out/sketch3_0.svg");

	maison->align(Align::ALIGN_BOTTOM);
	UIManager::desktop()->dispatch("${tests}/out/sketch3_1.svg");

	maison->align(Align::ALIGN_TOP);
	UIManager::desktop()->dispatch("${tests}/out/sketch3_2.svg");

	maison->align(Align::ALIGN_VERTICAL);
	UIManager::desktop()->dispatch("${tests}/out/sketch3_3.svg");

	rect->size(360,16);
	maison->size(rect->size());
	maison->align(Align::ALIGN_LEFT);
	UIManager::desktop()->dispatch("${tests}/out/sketch3_6.svg");

	maison->align(Align::ALIGN_RIGHT);
	UIManager::desktop()->dispatch("${tests}/out/sketch3_4.svg");

	maison->align(Align::ALIGN_HORIZONTAL);
	UIManager::desktop()->dispatch("${tests}/out/sketch3_5.svg");
}
