...
void Edit::test1()
{
	...
	for (i = 0; i < 180; i+= 18)
	{
		spacer->font_size(i);
		String name;
		name.print("test/out/edit1_%d.svg", ++id);
...
//UIManager::desktop()->mainloop();
	...
	"]");
	UIManager::notifier()->play_script(script, "test/out/edit2_%d.svg");
}
...
void Edit::test3()
{
	...
	UIManager::notifier()->play_script(script, "test/out/edit3_%d.svg");
}
...
void Edit::test4()
{
	...
	UIManager::notifier()->play_script(script, "test/out/edit4_%d.svg");
}
	...
	while (events[i].type != 0)
	{
		...
		if (events[i].type == KEY_EVT)
		{
			...
			else
			{
				...
				{
					test_name.print("test/out/edit5_%d.svg", ++id);
				}
			}
		}
...
void Edit::test6()
{
	...
	UIManager::notifier()->play_script(script, "test/out/edit6_%d.svg");
}
...
void Edit::test7()
{
	...
	UIManager::notifier()->play_script(script, "test/out/edit7_%d.svg");
}
