	...
	Window window2;
		...
		Grid * grid = new Grid(&window2);
			...
			button = new Button(grid);
				...
				button->text_align(Align::ALIGN_TOP_LEFT);
				button->extend(Extend::EXTEND_NONE);
	UIManager::desktop()->dispatch("$(ui.tests)/out/button4.svg");
}
...
void Button::test5()
{
	...
	Window window;
		...
		UIManager::desktop()->dispatch("$(ui.tests)/out/button5_1.svg");
		button->text("Press");
		UIManager::desktop()->dispatch("$(ui.tests)/out/button5_2.svg");
		button->font_size(30);
		UIManager::desktop()->dispatch("$(ui.tests)/out/button5_3.svg");
		button->pressed(true);
		UIManager::desktop()->dispatch("$(ui.tests)/out/button5_4.svg");
...
void Button::test6()
{
	...
	UIManager::desktop()->dispatch("$(ui.tests)/out/button6.svg");
}
...
*/
	...
	//while(1)
	{
		...
		UIManager::desktop()->dispatch("$(ui.tests)/out/button7_1.svg");

		{
			...
			{
				File out;
				out.open("$(ui.tests)/out/button7_1.json","w");
		...
		UIManager::desktop()->dispatch("$(ui.tests)/out/button7_2.svg");
		grid->clear(); 

		test_keyboard(grid, keyboardNum1);
		UIManager::desktop()->dispatch("$(ui.tests)/out/button7_3.svg");
		grid->clear(); 

		test_keyboard(grid, keyboardNum2);
		UIManager::desktop()->dispatch("$(ui.tests)/out/button7_4.svg");
		grid->clear(); 
	}
}
...
void Button::test9()
{
	...
	UIManager::desktop()->dispatch("$(ui.tests)/out/button9_1.svg");
}
...
void Button::test10()
{
	...
	"["
		...
		"{'type':'key','key':9208,'state':'up'  ,'modifier':''     ,'character':' '},"
	"]");
	UIManager::notifier()->play_script(script, "$(ui.tests)/out/button10_%d.svg");
}
...
void Button::test11()
{
	...
	String script(
	"["
		"{'type':'snapshot','filename':'$(ui.tests)/out/button11_%d.svg'},"
		"{'type':'key','key':9208,'state':'down','modifier':''     ,'character':' '},"
		"{'type':'key','key':9208,'state':'up'  ,'modifier':''     ,'character':' '},"
...
void Button::test12()
{
	...
	for (Dim gap = 0; gap <= 3; gap ++)
	{
		for (Dim thickness = 0; thickness <= 3; thickness ++)
		{
			...
			name.print("$(ui.tests)/out/button12_%d.svg", ++id);
...
void Button::test13()
{
	...
	"["
		...
		"{'type':'key','key':9208,'state':'up'  ,'modifier':''     ,'character':' '},"
	"]");
	UIManager::notifier()->play_script(script, "$(ui.tests)/out/button13_%d.svg");
}
...
void Button::test14()
{
	...
	Switch * check;
		...
		//UIManager::desktop()->dispatch("$(ui.tests)/out/button13.svg");
	while(1)
		UIManager::desktop()->dispatch();
}
	...
	Window window;
		...
		{ 
			button = new Button(row);
				...
				name.print("$(ui.tests)/out/button15_%d.svg", ++id);
				UIManager::desktop()->dispatch(name);
				delete button;
		}
}
	...
	Window window;
		...
		{ 
			button = new Button(row);
				...
				name.print("$(ui.tests)/out/button16_%d.svg", ++id);
				UIManager::desktop()->dispatch(name);
				delete button;
		}
}
	...
	Window window;
		...
		{ 
			button = new Button(row);
				...
				name.print("$(ui.tests)/out/button17_%d.svg", ++id);
				UIManager::desktop()->dispatch(name);
				delete button;
		}
}
