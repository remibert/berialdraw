...
//UIManager::desktop()->mainloop();
	...
	UIManager::notifier()->play_script(script, "${tests}/out/slider1_%d.svg");
}
...
void Slider::test2()
{
	...
	UIManager::notifier()->play_script(script, "${tests}/out/slider2_%d.svg");
}
...
void Slider::test3()
{
	...
	UIManager::notifier()->play_script(script, "${tests}/out/slider3_%d.svg");
}
...
void Slider::test4()
{
	...
	UIManager::desktop()->dispatch("${tests}/out/slider4_1.svg");
	...
	UIManager::desktop()->dispatch("${tests}/out/slider4_2.svg");
}
