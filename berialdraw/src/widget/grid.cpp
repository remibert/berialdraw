...
void Grid::test1()
{
	...
	for(int i = 0; i <= 480; i += 60)
	{
		...
		{
			String name;
			name.print("test/out/grid1_%d.svg", ++id);
...
void Grid::test2()
{
	...
	for(int i = 0; i < 470; i += 30)
	{
		...
		{
			String name;
			name.print("test/out/grid2_%d.svg", ++id);
			UIManager::desktop()->dispatch(name);
		}
		else
		{
...
void Grid::test3()
{
	...
	for(; i < 470; i += 30)
	{
		...
		{
			String name;
			name.print("test/out/grid3_%d.svg", ++id);
			UIManager::desktop()->dispatch(name);
		}
		else
		{
...
void Grid::test4()
{
	...
	for(i = 20, increment = 3, j = 0; i <= 480; i += increment)
	{
		...
		{
			String name;
			name.print("test/out/grid4_%d.svg", ++id);
			UIManager::desktop()->dispatch(name);
		}
		else
		{
...
void Grid::test5()
{
	...
	for(i = 20, increment = 3, j = 0; i <= 480; i += increment)
	{
		...
		{
			String name;
			name.print("test/out/grid5_%d.svg", ++id);
			UIManager::desktop()->dispatch(name);
		}
		else
		{
