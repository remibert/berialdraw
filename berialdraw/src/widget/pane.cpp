...
void Pane::test1()
{
	...
	for(int i = 0; i < 40; i += 1)
	{
		...
		{
			String name;
			name.print("${ui.tests}/out/pane1_%d.svg", ++id);
...
void Pane::test2()
{
	...
	UIManager::desktop()->dispatch("${ui.tests}/out/pane2.svg");
}
...
void Pane::test3()
{
	...
	for(int i = 0; i < 50; i += 3)
	{
		...
		{
			String name;
			name.print("${ui.tests}/out/pane3_%d.svg", ++id);
			UIManager::desktop()->dispatch(name);
		}
		else
		{
...
void Pane::test4()
{
	...
	UIManager::desktop()->dispatch("${ui.tests}/out/pane4_1.svg");
}
...
void Pane::test5()
{
	...
	UIManager::desktop()->dispatch("${ui.tests}/out/pane5_1.svg");
}
