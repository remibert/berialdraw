...
void Window::test1()
{
	...
	UIManager::desktop()->dispatch("test/out/window1_0.svg");
	
	window1.front();
	UIManager::desktop()->dispatch("test/out/window1_1.svg");

	window1.back();
	UIManager::desktop()->dispatch("test/out/window1_2.svg");

	window2.front();
	UIManager::desktop()->dispatch("test/out/window1_3.svg");
}
...
void Window::test2()
{
	...
	UIManager::desktop()->dispatch();
	{
		...
		UIManager::desktop()->dispatch("test/out/window2_1.svg");
		...
		UIManager::desktop()->dispatch("test/out/window2_2.svg");
	}
}
...
void Window::test3()
{
	...
	//while(true)
	{
		...
		UIManager::desktop()->dispatch("test/out/window3_1.svg");
		...
		UIManager::desktop()->dispatch("test/out/window3_2.svg");
	}
}
...
void Window::test4()
{
	...
	UIManager::desktop()->dispatch("test/out/window4_1.svg");
}
...
void Window::test5()
{
	// No geometry defined
	{
		Window window;
		window_test5(window);
		UIManager::desktop()->dispatch("test/out/window5_1.svg");
	}
	...
	// Only position defined
	{
		...
		window_test5(window);
		UIManager::desktop()->dispatch("test/out/window5_2.svg");
	}
	...
	// Size defined
	{
		...
		window.size(160,180);
		window_test5(window);
		UIManager::desktop()->dispatch("test/out/window5_3.svg");
	}
	...
	// Size and position defined
	{
		...
		window.size(160,180);
		window_test5(window);
		UIManager::desktop()->dispatch("test/out/window5_4.svg");
	}
	...
	// No geometry defined align
	{
		...
		UIManager::desktop()->dispatch("test/out/window5_6.svg");
		window.align(Align::ALIGN_TOP);
		UIManager::desktop()->dispatch("test/out/window5_7.svg");
		window.align(Align::ALIGN_LEFT);
		UIManager::desktop()->dispatch("test/out/window5_8.svg");
		window.align(Align::ALIGN_RIGHT);
		UIManager::desktop()->dispatch("test/out/window5_9.svg");
	}
	...
	// No geometry defined extend
	{
		...
		UIManager::desktop()->dispatch("test/out/window5_10.svg");
		window.extend(Extend::EXTEND_HEIGHT);
		UIManager::desktop()->dispatch("test/out/window5_11.svg");
	}
}
...
void Window::test6()
{
	Window window;
		...
		UIManager::desktop()->dispatch("test/out/window6_1.svg");
}
...
void window_test7(Widget * widget, int &id)
{
	...
	String name;
	name.print("test/out/window7_%d.svg",id++);
...
void Window::test8()
{
	...
	UIManager::desktop()->dispatch("test/out/window8_1.svg");
	UIManager::colors()->appearance("test_dark");
	UIManager::desktop()->dispatch("test/out/window8_2.svg");
	UIManager::colors()->appearance("test_light");
	UIManager::desktop()->dispatch("test/out/window8_3.svg");
}
...
void Window::test9()
{
	...
	for (Coord i = 100; i < 240; i+= 7)
	{
		...
		UIManager::desktop()->dispatch();
		String name;
		name.print("test/out/window9_%d.svg", ++id);
		UIManager::desktop()->dispatch(name);
	}
}
