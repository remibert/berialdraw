...
void bind_button(pybind11::module_& m) {
    ...
    pybind11::class_<berialdraw::Button, berialdraw::Widget, berialdraw::TextStyle, berialdraw::PaddingStyle, berialdraw::BorderStyle, std::unique_ptr<berialdraw::Button, pybind11::nodelete>>(m, "Button")
