...
void bind_edit(pybind11::module_& m) {
    ...
    pybind11::class_<berialdraw::Edit, berialdraw::Widget, berialdraw::TextStyle, berialdraw::PaddingStyle, berialdraw::BorderStyle, berialdraw::EditStyle, berialdraw::Entry>(m, "Edit")
