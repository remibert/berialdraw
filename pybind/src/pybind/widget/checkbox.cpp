...
void bind_checkbox(pybind11::module_& m) {
    pybind11::class_<berialdraw::Checkbox, berialdraw::Widget, berialdraw::TextStyle, berialdraw::PaddingStyle, berialdraw::BorderStyle, berialdraw::CheckboxStyle>(m, "Checkbox")
