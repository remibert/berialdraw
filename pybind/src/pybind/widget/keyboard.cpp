...
void bind_keyboard(pybind11::module_& m) {
    pybind11::class_<berialdraw::Keyboard, berialdraw::Widget, berialdraw::TextStyle, berialdraw::PaddingStyle, berialdraw::BorderStyle, std::unique_ptr<berialdraw::Keyboard, pybind11::nodelete>>(m, "Keyboard")
