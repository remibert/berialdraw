...
void bind_slider(pybind11::module_& m) {
    pybind11::class_<berialdraw::Slider, berialdraw::Widget, berialdraw::BorderStyle, berialdraw::SliderStyle, std::unique_ptr<berialdraw::Slider, pybind11::nodelete>>(m, "Slider")
