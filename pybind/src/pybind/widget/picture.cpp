...
void bind_picture(pybind11::module_& m) {
    pybind11::class_<berialdraw::Picture, berialdraw::Widget, berialdraw::BorderStyle, berialdraw::PictureStyle, std::unique_ptr<berialdraw::Picture, pybind11::nodelete>>(m, "Picture")
