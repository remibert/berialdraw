...
void bind_label(pybind11::module_& m) {
    pybind11::class_<berialdraw::Label, berialdraw::Widget, berialdraw::PaddingStyle, berialdraw::TextStyle, std::unique_ptr<berialdraw::Label, pybind11::nodelete>>(m, "Label")
