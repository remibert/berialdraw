...
void bind_switch(pybind11::module_& m) {
    pybind11::class_<berialdraw::Switch, berialdraw::Widget, berialdraw::TextStyle, berialdraw::PaddingStyle, berialdraw::BorderStyle, berialdraw::SwitchStyle, std::unique_ptr<berialdraw::Switch, pybind11::nodelete>>(m, "Switch")
