...
void bind_icon(pybind11::module_& m) {
    pybind11::class_<berialdraw::Icon, berialdraw::Widget, berialdraw::BorderStyle, berialdraw::IconStyle, berialdraw::PaddingStyle, berialdraw::TextStyle, std::unique_ptr<berialdraw::Icon, pybind11::nodelete>>(m, "Icon")
